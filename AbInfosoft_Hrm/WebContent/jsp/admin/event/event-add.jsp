					...
					<div class="row">
						...
						<!--	start: PAGE TITLE & BREADCRUMB -->
							...
							<div class="page-header">
								<h1>Add Event  <small>overview &amp; Details </small></h1>
							</div>
						...
						<div class="col-md-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<h2><i class="fa fa-pencil-square teal"></i> REGISTER EVENT</h2>
										<hr>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" placeholder="Insert  Event Title" class="form-control" id="firstname" name="firstname">
												</div>
												<div class="form-group">
													<label class="control-label">
														Event Sponsors <span class="symbol required"></span>
													</label>
													<input type="text" placeholder="Insert Event Sponsors " class="form-control" id="lastname" name="lastname">
												</div>
												<div class="form-group">
													<label class="control-label">
														Repeats Annually <span class="symbol required"></span>
													</label>
