					...
					<fieldset>
						...
						<div class="form-group form-actions">
							<span class="input-icon">
								...
								<a class="forgot" href="login_example16255.html?box=forgot">
						...
						<div class="new-account">
							...
							<a href="login_example16cf4.html?box=register" class="register">
								Create an account
							</a>
						</div>
					</fieldset>
			...
			<div class="box-forgot">
				...
				<form class="form-forgot">
					...
					<fieldset>
						...
						<div class="form-actions">
							<a href="login_example1acc1.html?box=login" class="btn btn-light-grey go-back">
